...
const i18n = {
  es: {
    ...
    "hero.tag":"Masaje Terapéutico y Estiramiento Activo Aislado · LIC","hero.title1":"Bienvenido a","hero.title2":"L.I.C MASSAGE AND STRETCH THERAPY",
    ...
    "a3d.tag":"Anatomía en Movimiento","a3d.title":"Entendemos tu cuerpo en cada eje",
   ...
   "terapia.tag":"Estiramiento y fortalecimiento activo aislado, el método Mattes.","terapia.title1":" TERAPIA DE ESTIRAMIENTO",
    ...
    "md.b1.body":"Un masaje integral y manipulación de los tejidos blandos que alivia el estrés y la tensión, a la vez que mejora la circulación sanguínea y linfática; la presión aplicada es de ligera a media. El objetivo principal es la relajación. El masaje sueco es una introducción ideal a la calma y los beneficios de la terapia de masaje. Puede incluir algo de Estiramiento Activo Aislado ligero.",
    "md.booknow":"RESERVAR AHORA",
    "md.b2.head":"Masaje de Presión Profunda / sesión  (1/2 hr $90 – 1 hr. $140 – 1.5 hr. $190)",
    "md.b2.body":"Diseñado para enfocarse en afecciones o zonas de molestia específicas. Esta sesión es ideal para cualquier persona que busque aliviar dolores y molestias corporales causados por tensión muscular, sobrecarga muscular y/o un trauma, y para atletas, antes y después de los eventos, para drenar la fatiga, aliviar la hinchazón, reducir la tensión muscular, promover la flexibilidad y prevenir lesiones. Para quienes tienen desgarros musculares, esguinces, atrapamientos nerviosos y dolor crónico de espalda u hombros, este tratamiento es sumamente efectivo. Puede incluir Estiramiento Activo Aislado.",
    "md.b3.head":"Cómo Dar un Masaje a tu Pareja  (1.5 hr- $205)",
    "md.b3.body":"¿Tu pareja siempre te pide que le alivies el dolor de cuello, hombros o espalda, y después de cinco minutos no tienes idea de qué hacer? ¿Siempre has querido darle a tu pareja un masaje relajante y reconfortante? Si es así, ¡esto es para ti! Esta sesión relajada de una hora y media incorpora las mejores técnicas que te guían para que puedas darle a tu pareja el masaje más sanador y placentero. Durante esta sesión relajante también aprenderás qué hacer y qué no hacer, dónde y cómo aplicar la presión correctamente, para que no te lastimes a ti ni a tu pareja. La mitad del tiempo entrenaré a una persona mientras la otra está en la camilla, y luego la otra mitad entrenaré a la otra. Esta sesión está pensada para enseñarte a trabajar con tu pareja o familia, no es una sesión avanzada. Será relajante y divertida. Está abierta a cualquier pareja. Escríbenos por correo si tienes preguntas.",
    "md.b4.head":"Sesión de Relajación Guiada  (45 mins- $70)",
    "md.b4.body":"El objetivo de esta sesión es ayudarte a relajarte, respirar y visualizarte de una forma nueva y empoderadora. Está orientada a ayudarte a estar menos nervioso y ansioso, y a preocuparte menos. Puede ayudarte con tu desempeño en el trabajo, en el deporte y en la vida cotidiana. Es para quienes desean cambiar malos hábitos y para quienes quieren perder peso, entre otras cosas. Saldrás con herramientas que te ayudarán a diario. Las sesiones de relajación y visualización guiada son utilizadas por atletas profesionales, líderes corporativos y actores para estar más relajados y alcanzar sus metas. Estarás sobre una camilla de masaje, completamente vestido.",
    "md.gift":"CERTIFICADOS DE REGALO DISPONIBLES",
    ...
    "about.tag":"Conoce a tu Terapeuta","about.title1":"LA PERSONA DETRAS DE LA ","about.title2":"SANACIÓN",
   ...
   "t1.text":"Raúl es uno de los mejores masajistas que he tenido. Aborda tus inquietudes de forma integral y te brinda las herramientas para llevar una vida más tranquila y sin dolor mediante estiramientos específicos y efectivos que puedes hacer regularmente en casa. Es increíblemente amable, cálido y profesional. He vuelto muchas veces y seguiré haciéndolo durante años. ¡Lo recomiendo ampliamente!",
    ...
    "page.title.index":"Bienvenido a LIC Massage Therapy and Stretching",
...
// Pricing — header
"pr.title": "Selecciona tu experiencia ",
...
"book.cta.heading":"Book your session","book.cta.sub":"I’ll respond within 24 hours.","book.cta.btn":"Book Now","book.chip.hours":"Mon–Fri: 10am–7pm · Sáb: 10am–6pm · Dom: 10am - 5pm","book.chip.location": "10-44 Jackson Ave, Long Island City, NY 11101, Estados Unidos",
    ...
    "hero.tag":"Therapeutic Massage and Active Isolated Stretching · LIC","hero.title1":"Welcome to","hero.title2":"L.I.C MASSAGE AND STRETCH THERAPY",
    ...
    "a3d.tag":"Anatomy in Motion","a3d.title":"We understand your body on every axis",
    ...
    "md.b1.body":"An all-around massage and manipulation of soft tissue that relieves stress and tension, while enhancing blood and lymph circulation, pressure applied is lite to medium. The main purpose is relaxation.  Swedish massage is an ideal introduction to the peacefulness and benefits of massage therapy. It may include some lite Active Isolated stretching.",
    "md.booknow":"BOOK NOW",
    "md.b2.head":"Deep Pressure Massage / session  (1/2 hr $90 – 1 hr. $140 – 1.5 hr. $190)",
    "md.b2.body":"Designed to focus on specific conditions or areas of discomfort. This session is good for anybody looking to relieve body aches and pains caused by muscle tension, muscle over used, and/or a trauma, and athletes, before and after events, to drain away fatigue, to relieve swelling, to reduce muscle tension, to promote flexibility and to prevent injuries.  For those with muscle tears, sprains, nerve impingements , and chronic back or shoulder pain, this treatment is extremely effective. It may include Active Isolated stretching.",
    "md.b3.head":"How To Massage Your Partner  (1.5 hr- $205)",
    "md.b3.body":"Does your partner always ask you to soothe away their neck, shoulder or back pain, and after five minutes you have no idea what to do? Have you always wanted to give your partner a relaxing, soothing massage? If so, this is for you! This hour and a half relaxed session,  incorporates the best techniques that guide you so you can give your partner the best most healing & peaceful massage. During this relaxing session you will also learn what to do and what not to do, where and how to apply pressure properly, so you don't hurt yourself or your partner. Half of the time I will coach one partner, while the other is on the table, then the other half I will coach the other partner. This session is intended to teach you how to work on your partner or family, not an advance session. It will be relaxing and fun. It is open to any partners. Please email with questions.",
    "md.b4.head":"Guided Relaxation Session  (45 mins- $70)",
    "md.b4.body":"The focus of this session is to get you to relax, breathe and visualize yourself in a new and empowering way. It is aimed at helping you be less nervous and anxious and worry less. It can help you with your performance at work, in sports and in everyday life. It's for those wanting to change bad habits and those wanting to lose weight, among other things. You will leave with tools that will help you on a daily basis. Guided relaxation and visualization sessions are being used by professional athletes, corporate leaders and actors to help them be more relaxed and achieve their goals. You will be on a massage table, fully dressed.",
    "md.gift":"GIFT CERTIFICATES AVAILABLE",
   ...
   "book.title1":"CONTACT","book.title2":"/POLICIES",
    ...
    "page.title.index":"Welcome to LIC Massage Therapy and Stretching",
